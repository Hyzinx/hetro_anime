...
class _MovieApi implements MovieApi {
  ...
  @override
  Future<ResponseResult> getMoviesPlayNow(String authKey) async {
  ...
  @override
  Future<ResponseResult> getMoviesUpcoming(String authKey) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': authKey};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<ResponseResult> getMoviesTopRated(String authKey) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': authKey};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<ResponseResult> getMoviesPopular(String authKey) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': authKey};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<Movie> getMovieById(int id, String authKey) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': authKey};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<Map<String, List<Genre>>> getAllGenreList(String authKey) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': authKey};
    _headers.removeWhere((k, v) => v == null);
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late Map<String, List<Genre>> _value;
    try {
